This project is a complete Retail Data Analytics Dashboard built using Power BI, based on sales data from Blinkit, India’s leading instant grocery delivery platform.
The dashboard transforms raw retail data into actionable business insights using interactive visualizations and KPI tracking.
...
Slicers for category & outlet type
